...
@section('title', 'Sửa đơn hàng Blood Strike')
@section('content')
<div class="container mt-5">
    <h3>
        Sửa đơn hàng Blood Strike
    </h3>
    ...
    <form action="{{ route('blood-strike-order.update', ['blood_strike_order' => $order['id']]) }}" method="post" id="bloodStrikeOrderForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex" style="gap: 8px">
            <button type="submit" class="btn btn-primary mt-3" id="updateBloodStrikeOrderButton">Cập nhật đơn hàng</button>
