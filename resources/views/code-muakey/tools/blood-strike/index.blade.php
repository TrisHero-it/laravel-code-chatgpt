...
@section('title', 'Blood Strike')
@section('content')
<div class="container mt-5">
    <div class="d-flex justify-content-between">
        <div>
            <h3>Danh sách đơn hàng Blood Strike</h3>
        </div>
        <div class="d-flex" style="gap: 8px; height: 42px;">
            <a href="{{ route('blood-strike-order.create') }}" class="btn btn-primary">
    ...
    <div class="card mt-3 mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('blood-strike-order.index') }}" class="d-flex gap-2 align-items-end">
                ...
                <div>
                    ...
                    @if (request()->query('search'))
                        <a href="{{ route('blood-strike-order.index') }}" class="btn btn-secondary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex" style="gap: 5px;">
                                ...
                                <?php endif; ?>
                                <a href="{{ route('blood-strike-order.edit', ['blood_strike_order' => $order['id']]) }}"
