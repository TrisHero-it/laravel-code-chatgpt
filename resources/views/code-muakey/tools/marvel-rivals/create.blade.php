...
@section('title', 'Thêm đơn hàng Marvel Rivals')
@section('content')
<div class="container mt-5">
    ...
    <div class="container mt-5">
        <h3>Thêm đơn hàng Marvel Rivals</h3>

        <form action="{{ route('marvel-rivals-order.store') }}" method="post" id="marvelRivalsOrderForm">
            @csrf
            <div class="form-group mt-3">
                ...
                <textarea class="form-control" id="order_data" name="order_data" rows="6"
                    placeholder="Dán thông tin đơn hàng vào đây (ví dụ:&#10;Mã ĐH: 1377955&#10;Sản phẩm: 5680 Lattices Marvel Rivals Chỉ Cần ID x 1&#10;UID: Marvel Rivals: 502763640&#10;Ngày mua: 20:33:20 23/08/2026)" required></textarea>
            ...
            <div class="d-flex" style="gap: 8px">
                ...
                <a href="{{ route('marvel-rivals-order.index') }}" class="btn btn-secondary mt-3">Quay lại</a>
            </div>
        </form>
    </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function parseOrderData(text) {
                ...
                // Parse UID: "UID: Marvel Rivals: 502763640"
                const uidMatch = text.match(/UID:?\s*Marvel\s*Rivals:\s*(\d+)/i) ||
                ...
                // Parse Product Name: "Sản phẩm: 500 Lattices Marvel Rivals Chỉ Cần ID x 1"
            ...
            continueAddBtn.addEventListener('click', function() {
                ...
                document.getElementById('marvelRivalsOrderForm').submit();
            });

            // Validate trước khi submit
            document.getElementById('marvelRivalsOrderForm').addEventListener('submit', function(e) {
                const orderId = orderIdInput.value.trim();
                const uid = uidInput.value.trim();
                const productId = productIdInput.value.trim();
