...
@section('title', 'Marvel Rivals')
@section('content')
<div class="container mt-5">
    <div class="d-flex justify-content-between">
        <div>
            <h3>Danh sách đơn hàng Marvel Rivals</h3>
        </div>
        <div class="d-flex" style="gap: 8px; height: 42px;">
            <a href="{{ route('marvel-rivals-order.create') }}" class="btn btn-primary">
    ...
    <div class="card mt-3 mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('marvel-rivals-order.index') }}" class="d-flex gap-2 align-items-end">
                ...
                <div>
                    ...
                    @if (request()->query('search'))
                        <a href="{{ route('marvel-rivals-order.index') }}" class="btn btn-secondary">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex" style="gap: 5px;">
                                ...
                                <?php endif; ?>
                                <a href="{{ route('marvel-rivals-order.edit', ['marvel_rivals_order' => $order['id']]) }}"
