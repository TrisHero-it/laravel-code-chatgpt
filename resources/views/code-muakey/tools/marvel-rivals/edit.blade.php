...
@section('title', 'Sửa đơn hàng Marvel Rivals')
@section('content')
<div class="container mt-5">
    <h3>
        Sửa đơn hàng Marvel Rivals
    </h3>
    ...
    <form action="{{ route('marvel-rivals-order.update', ['marvel_rivals_order' => $order['id']]) }}" method="post" id="marvelRivalsOrderForm" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="d-flex" style="gap: 8px">
            <button type="submit" class="btn btn-primary mt-3" id="updateMarvelRivalsOrderButton">Cập nhật đơn hàng</button>
